...
const config: SiteConfig = {
  ...
  website: {
    title: "Truong Hoang Huyen Minh's Blog", // Homepage title
    titleShort: "Chay Lung Tung", // Short site title for homescreen (PWA). Preferably should be under 12 characters to prevent truncation
    name: "CHAY LUNG TUNG Blog", // Website name used for homescreen (PWA) and SEO
    ...
    logoUrl: "/logos/chaylungtung_pfp.jpg", // Logo used for SEO
    url: "https://example.com", // Domain of your website without the pathPrefix
    rss: "/rss.xml", // Path to the RSS file
    rssTitle: "Truong Hoang Huyen Minh's Personal Blog", // Title of the RSS feed
